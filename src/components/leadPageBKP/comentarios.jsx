...
export const Comentarios = () => {
  ...
  /*function detectHostory(){
    ...
    const comentarios = useSelector(comnetarioSlice => comnetarioSlice.comentarios.items)
    const comnetFilter = comentarios.filter(comentData => (comentData.idProduct === localId))
                  ...
                  >
                    <div className="modal-dialog">
                      <div className="modal-content bg-transparent border-0">
                        ...
                        <div className="modal-body text-dark">
                          <ModalImageComentario data={datacoment} comnetario={comnetFilter}/>
                        </div>
