...
export const Acessorio = () => {
  ...
  useEffect(() =>{    
    (async() => {
      ...
      const req = await api.get("/category/daee8439-b25c-47a4-b1a5-72ab1cadb938")
  ...
  return (
    ...
    {categoroy == "" && categoroyData == "" ? <Example /> : 
      ...
      <ProductProd>
            ...
            return (
              <Link to={"/desc/" + id} target='_blank' onClick={() => LocalSto(res.products)}>
                <div key={id}>
